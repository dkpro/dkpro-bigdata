...
RUN="./run.sh de.tudarmstadt.ukp.dkpro.bigdata.collocations.CollocDriver -u --input wiktionary --output wiktionary_contingency_full --metric llr:0  -minV 0.1 -ow --maxRed 64"
