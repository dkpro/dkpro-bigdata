 ...
 ******************************************************************************/
package org.dkpro.bigdata.examples;
...
import org.dkpro.bigdata.hadoop.DkproMapper;
import org.dkpro.bigdata.hadoop.DkproReducer;
import org.dkpro.bigdata.io.hadoop.Text2CASInputFormat;
...
//				DictionaryAnnotator.PARAM_ANNOTATION_TYPE, Name.class);
    ...
    {
            ExternalDataExample pipeline = new ExternalDataExample();
